...
from backend.api.routers import auth, companies, pipeline, approvals, evidence, config, analytics, company_processing, indicators
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=sorted(set(_default_origins + _env_origins)),
...
app.include_router(company_processing.router)
